...
export default function ProductDetailFunction({product}) {
  ...
  return (product == undefined)?<div></div>:(
    <div className={styles.container}>
      <Head>
        <title>{product.title} - Market Master</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content={`${product.title} - Market Master`} />
        <meta
          property="og:description"
          content={`Description of the product ${product.title} from the online store Market Master which is an online store specializes in linen and cotton clothes such as guayaberas and guayamisas`}
        />
