...
export default function MenIndex() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Men Linen and Cotton Clothes - Market Master</title>
        <meta
          name="description"
          content={`Men Linen and Cotton Clothes at Market Master which is an online store specializes in linen and cotton clothes such as guayaberas and guayamisas`}
        />
        <link rel="icon" href="/favicon.ico" />
        <meta
          property="og:title"
          content="Men Linen and Cotton Clothes - Market Master"
        />
        <meta
