  ...
  return (category == undefined)?<div></div>:(
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content={`Description of the category ${category.title} made of linen and cotton at Market Master which is an online store specializes in linen and cotton clothes such as guayaberas and guayamisas`}
        />
