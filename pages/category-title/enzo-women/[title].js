...
export default function CategoryTitleWomanDetailFunction({category, products}) {
  ...
  return (category == undefined)?<div></div>:(
    <div className={styles.container}>
      <Head>
        <title>Category {category.title} - Market Master</title>
        <meta
          name="description"
          content={`Description of the category ${category.title} made of linen and cotton for women at Market Master which is an online store specializes in linen and cotton clothes such as guayaberas and guayamisas`}
        />
        <link rel="icon" href="/favicon.ico" />
        <meta property="og:title" content={`Category ${category.title} - Market Master`} />
        <meta
