      ...
      <Head>
        ...
        <meta
          ...
          content={`Description of the category ${
            category.title
          } made of linen and cotton for men at Market Master which is an online store specializes in linen and cotton clothes such as guayaberas and guayamisas`}
        />
        <link rel="icon" href="/favicon.ico" />
        <meta
          property="og:title"
          content={`Category ${category.title} - Market Master`}
        />
        <meta
