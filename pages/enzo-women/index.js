...
export default function WomenIndex() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Women Linen and Cotton Clothes - Market Master</title>
        <meta
          name="description"
          content={`Women linen and cotton clothes at Market Master which is an online store specializes in linen and cotton clothes such as guayaberas and guayamisas`}
        />
        <link rel="icon" href="/favicon.ico" />
        <meta property="og:title" content="Women Linen and Cotton Clothes - Market Master"/>
        <meta
