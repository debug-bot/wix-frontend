...
export default function CustomProductDetailFunction() {
  ...
  return (product == undefined)?<div></div>:(
    <div className={styles.container}>
       <Head>
        <title>{product.product.title} - Market Master</title>
        <meta
          name="description"
          content={`Customization of the product ${product.product.title} at Market Master which is an online store specializes in linen and cotton clothes such as guayaberas and guayamisas`}
        />
        <link rel="icon" href="/favicon.ico" />
        <meta property="og:title" content={`${product.product.title} - Market Master`} />
        <meta
