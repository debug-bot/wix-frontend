  ...
  return (collection == undefined)?<div></div>:(
    <div className={styles.container}>
       <Head>
        ...
        <meta
          name="description"
          content={`Collection ${collection.title} for men at Market Master which is an online store specializes in linen and cotton clothes such as guayaberas and guayamisas`}
        />
