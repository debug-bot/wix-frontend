    ...
    if (key == "shipping") {
      return (
        <p className={styles.about_p}>
          ...
          <strong>Market Master</strong>, it takes from 7 days to two weeks
    ...
    if (key == "shipping") {
      return (
        <p className={styles.about_p}>
          ...
          <strong>Market Master</strong>, los productos tardan entre 10 días
          ...
          través de nuestra web <strong>Market Master</strong>.
        </p>
      );
    } else if (key == "contact") {
      return (
